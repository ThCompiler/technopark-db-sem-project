...
import (
	...
	rp "tech-db-forum/internal/app/repository"
	postgresql_utilits2 "tech-db-forum/internal/pkg/utilits/postgresql"
...
func (repo *CreatorRepository) SearchCreators(pag *models.Pagination,
	...
	limit, offset, err := postgresql_utilits2.AddPagination("search_creators", pag, repo.store)
	if err != nil {
		return nil, err
	}
	...
	query = postgresql_utilits2.CustomRebind(4, query)
