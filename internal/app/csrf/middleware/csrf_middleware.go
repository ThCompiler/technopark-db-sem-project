...
import (
	...
	hf "tech-db-forum/internal/app/delivery/http/handlers/base_handler/handler_interfaces"
	"tech-db-forum/internal/app/delivery/http/handlers/handler_errors"
	utilits2 "tech-db-forum/internal/pkg/utilits"
	http2 "tech-db-forum/internal/pkg/utilits/http"

	"github.com/sirupsen/logrus"
)

type CsrfMiddleware struct {
	log     utilits2.LogObject
	usecase usecase_csrf.Usecase
}

func NewCsrfMiddleware(log *logrus.Logger, uc usecase_csrf.Usecase) *CsrfMiddleware {
	return &CsrfMiddleware{
		log:     utilits2.NewLogObject(log),
		usecase: uc,
	}
}
...
func (mw *CsrfMiddleware) CheckCsrfTokenFunc(next hf.HandlerFunc) hf.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		respond := http2.Responder{LogObject: mw.log}
